# /users/jiwonpark/L1Skim/V5 (CMSSW_9_1_0_pre3)
...
process.HLTConfigVersion = cms.PSet(
  tableName = cms.string('/users/jiwonpark/L1Skim/V5')
)
...
process.hltL1sSingleEG40orSingleIsoEG38orSingleIsoEG36er2p1orDoubleEG2514orTripleEG18178 = cms.EDFilter( "HLTL1TSeed",
    L1SeedsLogicalExpression = cms.string( "L1_SingleEG40 OR L1_SingleIsoEG38 OR L1_SingleIsoEG36er2p1 OR L1_DoubleEG_25_14 OR L1_TripleEG_18_17_8" ),
...
process.HLTPreEGSkimmer = cms.EDFilter( "HLTPrescaler",
...
process.SkimL1EG = cms.Path( process.HLTBeginSequence + process.hltL1sSingleEG40orSingleIsoEG38orSingleIsoEG36er2p1orDoubleEG2514orTripleEG18178 + process.HLTPreEGSkimmer + process.HLTEndSequence )
...
process.HLTSchedule = cms.Schedule( *(process.HLTriggerFirstPath, process.SkimL1EG, process.HLTriggerFinalPath, process.HLTAnalyzerEndpath ))


process.source = cms.Source( "PoolSource",
    fileNames = cms.untracked.vstring(
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/0A44DAEA-F305-E711-9105-FA163E3559D1.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/36839613-F405-E711-9F1E-FA163E323BD0.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/0C529506-F405-E711-9C4B-FA163E33D51A.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/3C2F0F02-F405-E711-99E0-FA163E1BF4C1.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/123731F3-F305-E711-BAAD-FA163E85666C.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/4E04A246-F405-E711-8287-02163E00B2AB.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/144BE2FE-F305-E711-93CC-FA163E0259B5.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/90212AE7-F305-E711-90A2-FA163EF78E5D.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/1EE586E8-F305-E711-8B8E-FA163E570AB1.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/BE27C904-F405-E711-9621-FA163E9B0DA9.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/201F7E1E-F405-E711-8DFB-FA163EB16F61.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/EE3C38CE-AB07-E711-8B1B-02163E012E68.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/2C0CAE59-F405-E711-AAF5-FA163EF7B742.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/F64739E7-F305-E711-AB30-FA163EEBD3A9.root',
        '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/307D9912-F405-E711-A1FE-FA163E985227.root',
    ),
...
if 'hltTrigReport' in process.__dict__:
    process.hltTrigReport.HLTriggerResults                    = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreExpressCosmicsOutputSmart' in process.__dict__:
    process.hltPreExpressCosmicsOutputSmart.hltResults = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreExpressOutputSmart' in process.__dict__:
    process.hltPreExpressOutputSmart.hltResults        = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreDQMForHIOutputSmart' in process.__dict__:
    process.hltPreDQMForHIOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreDQMForPPOutputSmart' in process.__dict__:
    process.hltPreDQMForPPOutputSmart.hltResults       = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreHLTDQMResultsOutputSmart' in process.__dict__:
    process.hltPreHLTDQMResultsOutputSmart.hltResults  = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreHLTDQMOutputSmart' in process.__dict__:
    process.hltPreHLTDQMOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltPreHLTMONOutputSmart' in process.__dict__:
    process.hltPreHLTMONOutputSmart.hltResults         = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )

if 'hltDQMHLTScalers' in process.__dict__:
    process.hltDQMHLTScalers.triggerResults                   = cms.InputTag( 'TriggerResults', '', 'L1SKIM' )
    process.hltDQMHLTScalers.processname                      = 'L1SKIM'

if 'hltDQML1SeedLogicScalers' in process.__dict__:
    process.hltDQML1SeedLogicScalers.processname              = 'L1SKIM'
...
_customInfo['inputFile' ]=  ['/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/0A44DAEA-F305-E711-9105-FA163E3559D1.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/36839613-F405-E711-9F1E-FA163E323BD0.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/0C529506-F405-E711-9C4B-FA163E33D51A.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/3C2F0F02-F405-E711-99E0-FA163E1BF4C1.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/123731F3-F305-E711-BAAD-FA163E85666C.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/4E04A246-F405-E711-8287-02163E00B2AB.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/144BE2FE-F305-E711-93CC-FA163E0259B5.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/90212AE7-F305-E711-90A2-FA163EF78E5D.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/1EE586E8-F305-E711-8B8E-FA163E570AB1.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/BE27C904-F405-E711-9621-FA163E9B0DA9.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/201F7E1E-F405-E711-8DFB-FA163EB16F61.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/EE3C38CE-AB07-E711-8B1B-02163E012E68.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/2C0CAE59-F405-E711-AAF5-FA163EF7B742.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/F64739E7-F305-E711-AB30-FA163EEBD3A9.root', '/store/mc/PhaseIFall16DR/SingleNeutrino/GEN-SIM-RAW/FlatPU28to62HcalNZSRAW_90X_upgrade2017_realistic_v6_C1-v1/90000/307D9912-F405-E711-A1FE-FA163E985227.root']
