void chi2_QCDFull(){
TFile *_file0 = TFile::Open("mc_TEST_QCDFull.root");
...
TCanvas *MyC=new TCanvas("MyC","chi square",400,400);
  ...
  h0->GetYaxis()->SetRangeUser(0,300000);
  ...
  h0->SetTitle("chi2 for EE and EB (QCD, pt 15 to 170);chi2;Events");
