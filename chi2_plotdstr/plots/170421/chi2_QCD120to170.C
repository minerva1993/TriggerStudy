void chi2_QCD120to170(){
TFile *_file0 = TFile::Open("mc_TEST_QCD120to170.root");
...
TCanvas *MyC=new TCanvas("MyC","chi square",400,400);
  ...
  h0->SetTitle("chi2 for EE and EB (QCD, pt 120 to 170);chi2;Events");
...
//  leg->SetHeader("DYJetsToLL","C");
  ...
  MyC->Print("plot_QCD120to170.pdf");
