void chi2_QCD80to120(){
TFile *_file0 = TFile::Open("mc_TEST_QCD80to120.root");
...
TCanvas *MyC=new TCanvas("MyC","chi square",400,400);
  ...
  h0->SetTitle("chi2 for EE and EB (QCD, pt 80 to 120);chi2;Events");
